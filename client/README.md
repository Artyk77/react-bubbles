...
- [ x] Explain what a token is used for.
  ...
  A token allows for authentication on the server, letting us to enable PrivateRoutes

- [ x] What steps can you take in your web apps to keep your data secure?

  Enable stepwise authentication, like `axiosWithAuth`

- [x ] Describe how web servers work.

  Simply put, a client makes a HTTP request and the server makes a HTTP response based on that request
